...
if(isset($_POST['add_product'])){
   ...
   $image_folder = 'uploaded_img/'.$image; //gắn với tên img
...
// check img size > 2000000 MB
      if($add_product_query){
         ...
         $message[] = 'product could not be added!'; //lỗi nhảm nhí nào đó 
      }
   }
}
//Delete
if(isset($_GET['delete'])){
   ...
   //phương thức xóa : https://www.w3schools.com/php/func_filesystem_unlink.asp
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <!-- click update/del dựa trên id sp -->
         <a href="admin_products.php?update=<?= $fetch_products['id'] ?>" class="option-btn">update</a>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="update_product_id" value="<?= $fetch_update['id'] ?>">
